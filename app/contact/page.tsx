      ...
      <div className="mx-auto max-w-5xl space-y-10">
        <div className="rounded-[2rem] border border-white/10 bg-surface2 p-10 shadow-soft">
          ...
          <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-300">
            Reach out for senior engineering leadership, AI infrastructure strategy, automation platform development, or backend architecture engagements.
          </p>
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            ...
            <div className="rounded-3xl border border-white/10 bg-surface p-6">
              ...
              <p className="mt-3 text-xl font-semibold text-white">Open for leadership, senior engineering, and AI systems work.</p>
            </div>
          </div>
        </div>
        <div className="rounded-[2rem] border border-white/10 bg-surface2 p-10 shadow-soft">
          <div className="space-y-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <Link href="https://www.linkedin.com/in/arnaldo-rocha-filho-52ba03163/" target="_blank" rel="noreferrer" className="rounded-3xl border border-white/10 bg-white/5 p-6 text-left transition hover:border-accent">
                ...
                <p className="mt-3 text-lg font-semibold text-white">Connect for AI infrastructure and automation leadership</p>
              </Link>
            </div>
          </div>
        </div>
