    ...
    <section className="px-6 py-24 lg:px-8">
      <div className="mx-auto max-w-6xl">
        <div className="mb-12 space-y-4">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-white sm:text-5xl">Backend architecture, infrastructure systems, and workflow orchestration.</h1>
        ...
        <div className="grid gap-10">
          <div className="rounded-[2rem] border border-white/10 bg-surface2 p-8 shadow-soft">
            <h2 className="text-2xl font-semibold text-white">Engineering direction</h2>
            <p className="mt-4 text-slate-300 leading-8">
              I build backend platforms that are secure, observable, and designed for teams. The engineering approach centers on API contracts, event-driven systems, and automation.
            </p>
          </div>
          <EngineeringCards />
          <div className="rounded-[2rem] border border-white/10 bg-surface2 p-8 shadow-soft">
